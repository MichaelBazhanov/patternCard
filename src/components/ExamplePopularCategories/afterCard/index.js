    ...
    >
          ...
          >
            ...
            <div className="relative w-full h-full inset-0">
              ...
              <PositionInCard top='0px' right='0px'>
                <a className="z-[1] relative w-[66px] h-[29px] xl:w-[114px] xl:h-[38px] flex justify-center items-center group"
                  onClick={alertFunction}
                  data-link="Карточка товара (c множеством ссылок)"
                ...
                >
                  ...
                  <div
                  className="z-[1] relative text-black px-[10px]_ py-[5px]_ ml-auto mr-2 xl:mr-7 whitespace-nowrap font-medium text-sm xl:text-lg 3xl:text-2xl
      ...
      <p className="max-h-[350px] h-full flex flex-col justify-end">
        <b className="block text-sm">
          ...
          <br />
          5) Внимание если в SVG Нужно манипулировать более чем 2 цветами на допустим HOVER(тп тд) то SVG должен вставляться напрямую а не через shadow-dom - use. В идеале SVG положить в компоннет и там уже работать с любым кол-во цветов.
        </b>
      </p>
    </section>
  );
